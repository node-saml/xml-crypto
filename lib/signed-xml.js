...
SignedXml.prototype.computeSignature = function(xml, xpathToNodeBeforeSignature, prefix) {  
  ...
  prefix = prefix || '';
  this.signatureXml = "<" + prefix + "Signature xmlns=\"http://www.w3.org/2000/09/xmldsig#\">"
...
SignedXml.prototype.createSignature = function(signedInfo, prefix) {
  ...
  var dummySignatureWrapper = "<" + prefix + "Signature xmlns=\"http://www.w3.org/2000/09/xmldsig#\">" +
                        signedInfo +
                        "</" + prefix + "Signature>"
