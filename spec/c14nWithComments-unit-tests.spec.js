...
var compare = function (xml, xpath, expected, inclusiveNamespacesPrefixList) {
    ...
    var result = can
        .process(elem, {inclusiveNamespacesPrefixList: inclusiveNamespacesPrefixList})
        .toString();
...
describe("Exclusive canonicalization with comments", function () {
    ...
    it("Exclusive canonicalization works on xml with prefixed namespaces defined in output nodes",
        function () {
            compare(
    ...
    it("Exclusive canonicalization works on xml with prefixed namespaces defined in output nodes. ns definition is not duplicated on each usage",
        function () {
            compare(
    ...
    it("Exclusive canonicalization works on xml with prefixed namespaces defined in output nodes but before used",
        function () {
            compare(
    ...
    it("Exclusive canonicalization works on xml with prefixed namespaces defined outside output nodes",
        function () {
            compare(
    ...
    it("Exclusive canonicalization works on xml with prefixed namespace defined in inclusive list",
        function () {
            compare(
    ...
    it("Exclusive canonicalization works on xml with multiple prefixed namespaces defined in inclusive list",
        function () {
            compare(
    ...
    it("Exclusive canonicalization works on xml with prefixed namespace defined in inclusive list defined outside output nodes",
        function () {
            compare(
    ...
    it("Exclusive canonicalization works on xml with prefixed namespace defined in inclusive list used on attribute",
        function () {
            compare(
    ...
    it("Exclusive canonicalization works on xml with default namespace inside output nodes",
        function () {
            compare(
    ...
    it("Exclusive canonicalization works on xml with multiple different default namespaces",
        function () {
            compare(
    ...
    it("Exclusive canonicalization works on xml with multiple similar default namespaces",
        function () {
            compare(
    ...
    it("Exclusive canonicalization works on xml with default namespace outside output nodes",
        function () {
            compare(
    ...
    it("Exclusive canonicalization works when prefixed namespace is defined in output nodes not in the parent chain of who needs it",
        function () {
            compare(
    ...
    it("Exclusive canonicalization works on xml with attributes with different namespace than element",
        function () {
            compare(
    ...
    it("Exclusive canonicalization works on xml with attribute and element values with special characters",
        function () {
            compare(
