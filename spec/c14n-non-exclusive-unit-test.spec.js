...
describe("C14N non-exclusive canonicalization tests", function () {
    ...
    it("findAncestorNs: Correctly picks up root ancestor namespace",
        function () {
    ...
    it("findAncestorNs: Correctly picks up intermediate ancestor namespace",
        function () {
    ...
    it("findAncestorNs: Correctly picks up multiple ancestor namespaces scattered among depth",
        function () {
    ...
    it("findAncestorNs: Correctly picks up multiple ancestor namespaces without duplicate",
        function () {
    ...
    it("findAncestorNs: Correctly eliminates duplicate prefix",
        function () {
    ...
    it("findAncestorNs: Ignores namespace declared in the target xpath node",
        function () {
...
// Tests for c14nCanonicalization
    it("C14n: Correctly picks up root ancestor namespace",
        function () {
            var xml = "<root xmlns:aaa='bbb'><child1><child2></child2></child1></root>";
            var xpath = "/root/child1/child2";
    ...
    it("C14n: Correctly picks up intermediate ancestor namespace",
        function () {
            var xml = "<root><child1 xmlns:aaa='bbb'><child2></child2></child1></root>";
            var xpath = "/root/child1/child2";
            var expected = '<child2 xmlns:aaa="bbb"></child2>';
    ...
    it("C14n: Correctly picks up multiple ancestor namespaces declared in the one same element",
        function () {
            var xml = "<root xmlns:aaa='bbb' xmlns:ccc='ddd'><child1><child2></child2></child1></root>";
            var xpath = "/root/child1/child2";
    ...
    it("C14n: Correctly picks up multiple ancestor namespaces scattered among depth",
        function () {
            var xml = "<root xmlns:aaa='bbb'><child1 xmlns:ccc='ddd'><child2></child2></child1></root>";
            var xpath = "/root/child1/child2";
            var expected = '<child2 xmlns:aaa="bbb" xmlns:ccc="ddd"></child2>';
    ...
    it("C14n: Correctly picks up multiple ancestor namespaces without duplicate",
        function () {
            var xml = "<root xmlns:ccc='bbb'><child1 xmlns:ccc='bbb'><child2></child2></child1></root>";
            var xpath = "/root/child1/child2";
    ...
    it("C14n: Correctly eliminates duplicate prefix",
        function () {
            var xml = "<root xmlns:ccc='bbb'><child1 xmlns:ccc='AAA'><child2></child2></child1></root>";
            var xpath = "/root/child1/child2";
    ...
    it("C14n: Exclude namespace which is already declared with same prefix on target node",
        function () {
            var xml =
                "<root xmlns:ccc='bbb'><child1 xmlns:ccc='AAA'><child2 xmlns:ccc='AAA'></child2></child1></root>";
            var xpath = "/root/child1/child2";
    ...
    it("C14n: Preserve namespace declared in the target xpath node",
        function () {
            var xml = '<root xmlns:aaa="bbb"><child1><child2 xmlns:ccc="ddd"></child2></child1></root>';
            var xpath = "/root/child1/child2";
            var expected = '<child2 xmlns:aaa="bbb" xmlns:ccc="ddd"></child2>';
    ...
    it("C14n: Don't redeclare an attribute's namespace prefix if already in scope",
        function () {
            var xml =
    ...
    it("C14n: Don't declare an attribute's namespace prefix if in scope from parent",
        function () {
            var xml =
