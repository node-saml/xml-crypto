...
module.exports = {
  "Exclusive canonicalization works on xml with no namespaces": function (test) {
    compare(test, "<root><child>123</child></root>", "//*", "<root><child>123</child></root>");
  },
  ...
  "Exclusive canonicalization works on xml with default namespace inside output nodes": function (
    test
  ) {
    compare(
      test,
  ...
  "Exclusive canonicalization works on xml with multiple different default namespaces": function (
    test
  ) {
    compare(
      test,
  ...
  "Exclusive canonicalization works on xml with multiple similar default namespaces": function (
    test
  ) {
    compare(
      test,
  ...
  "Exclusive canonicalization works on xml with default namespace outside output nodes": function (
    test
  ) {
    compare(
      test,
  ...
  "Exclusive canonicalization sorts upper case attributes before lower case": function (test) {
    compare(test, '<x id="" Id=""></x>', "//*[local-name(.)='x']", '<x Id="" id=""></x>');
  },
  ...
  "Exclusive canonicalization works on xml with element values with special characters": function (
    test
  ) {
    compare(
      test,
  ...
  "Exclusive canonicalization does not alter CR-NL (windows line separator) sequences": function (
    test
  ) {
    compare(
      test,
