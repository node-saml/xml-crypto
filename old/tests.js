var ExclusiveCanonicalization = require("./lib.js").ExclusiveCanonicalization
  , Dom = require('xmldom').DOMParser
  , select = require('./node_modules/ws.js/lib/xpath.js').SelectNodes
...
"Exclusive canonicalization works on xml with multiple similar default namespaces": function (test) {
  ...
  "Exclusive canonicalization works on xml with unordered attributes": function (test) {
    compare(test, 
      "<root><child xmlns:z=\"ns2\" xmlns:p=\"ns1\" p:name=\"val1\" z:someAttr=\"zval\" z:testAttr=\"ztestAttr\" someAttr=\"someAttrVal\" p:address=\"val2\"><inner>123</inner></child></root>", 
      "//*[local-name(.)='child']", 
      "<child xmlns:p=\"ns1\" xmlns:z=\"ns2\" someAttr=\"someAttrVal\" p:address=\"val2\" p:name=\"val1\" z:someAttr=\"zval\" z:testAttr=\"ztestAttr\"><inner>123</inner></child>")
  },
